...
function sum(a, b) { //eslint-disable-line
    let returnSum = a + b;
    let concatString = `The sum of ${a} and ${b} is ${returnSum}.`;
    let returnArray = [returnSum, concatString];
    return returnArray;
}
...
function multiply(a, b) { //eslint-disable-line
    ...
    let returnArray = [returnMul, concatString];
    return returnArray;
}
...
function sumArray(sumArr) { //eslint-disable-line
    let firstElement = sum(sum(sumArr[0], sumArr[1])[0], sumArr[2]);
    let secondElement = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${firstElement[0]} is their sum.`;
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    let secondElement = `The numbers ${dynamicArray} have a product of ${firstElement}.`;
    let returnArray = [firstElement, secondElement];
    return returnArray;
}
